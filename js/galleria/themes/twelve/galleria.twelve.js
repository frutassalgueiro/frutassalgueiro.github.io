...
Galleria.addTheme({
    ...
    defaults: {
        ...
        _locale: {
            show_thumbnails: 'Mostrar thumbnails',
            hide_thumbnails: 'Ocultar thumbnails',
            play: 'Iniciar presentación',
            pause: 'Detener presentación',
            enter_fullscreen: 'Ir a pantalla completa',
            exit_fullscreen: 'Salr a pantalla completa',
            popout_image: 'Popout imagen',
